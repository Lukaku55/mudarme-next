...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 2, "name": "Mudanzas en Lomas de Zamora", "item": "https://www.mudarme.com.ar/mudanzas-lomas-de-zamora" },
  ],
};
        ...
        <section className=\"bg-zinc-900 py-16 px-4\">
          <div className=\"max-w-4xl mx-auto\">
            ...
            <div className=\"space-y-4\">
              <div className=\"bg-zinc-800 border border-zinc-700 rounded-lg p-6\"><h3 className=\"font-bold text-lg mb-2 text-white\">Cuanto cuesta una mudanza desde CABA a Lomás de Zamora?","acceptedAnswer":{"@type":"Answer","text":"En La Mudanza hacemos presupuestos cerrados y sin cargo. Contactaños por WhatsApp para cotizar."}},
    {"@type":"Question","name":"Cubren Banfield y Temperley?","acceptedAnswer":{"@type":"Answer","text":"Si, cubrimos todo el partido de Lomás de Zamora incluyendo Banfield, Temperley y Llavallol."}},
    {"@type":"Question","name":"Hacen mudanzas dentro del partido de Lomás de Zamora?","acceptedAnswer":{"@type":"Answer","text":"Si, también hacemos mudanzas dentro del mismo partido."}},
    {"@type":"Question","name":"Tienen guardamuebles cerca de Lomás de Zamora?","acceptedAnswer":{"@type":"Answer","text":"Si, contamos con depositos accesibles desde Lomás de Zamora."}}
  ]
};
