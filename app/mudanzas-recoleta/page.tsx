...
export const metadata: Metadata = {
  title: "Mudanzas en Recoleta | Empresa de confianza | La Mudanza",
  description: "Mudanzas en Recoleta con cuidado profesional. Expertos en edificios históricos, pisos altos y accesos complejos. Presupuesto cerrado sin cargo. Llamanos.",
...
const localBusinessSchema = {
  ...
  "name": "La Mudanza - Mudanzas en Recoleta",
  "url": "https://www.mudarme.com.ar/mudanzas-recoleta",
  ...
  "areaServed": { "@type": "Place", "name": "Recoleta, Buenos Aires" },
  "aggregateRating": {
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 2, "name": "Mudanzas en Recoleta", "item": "https://www.mudarme.com.ar/mudanzas-recoleta" },
  ],
};
...
const faqSchema = {
  ...
  "mainEntity": [
    {"@type":"Question","name":"{s}</h3>
                  <p className=\"text-gray-400\">Realizamos {s.toLowerCase()} en Recoleta con vehiculos equipados y personal capacitado.</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className=\"bg-black py-16 px-4\">
          <div className=\"max-w-4xl mx-auto text-center\">
            <h2 className=\"text-3xl font-bold mb-4 text-white\">Por que elegirnos en Recoleta</h2>
            <div className=\"grid grid-cols-1 md:grid-cols-3 gap-6 mt-8\">
              <div className=\"p-6 border border-zinc-700 rounded-lg bg-zinc-800\">
                ...
                <p className=\"text-gray-400 text-sm mt-1\">Empresa familiar con trayectoria en Recoleta</p>
              </div>
              <div className=\"p-6 border border-zinc-700 rounded-lg bg-zinc-800\">
              ...
              <div className=\"p-6 border border-zinc-700 rounded-lg bg-zinc-800\">
                ...
                <p className=\"text-gray-400 text-sm mt-1\">Miles de mudanzas realizadas en Recoleta</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className=\"bg-zinc-900 py-16 px-4\">
          <div className=\"max-w-4xl mx-auto\">
            <h2 className=\"text-3xl font-bold mb-8 text-center text-white\">Preguntas frecuentes sobre mudanzas en Recoleta</h2>
            <div className=\"space-y-4\">
              <div className=\"bg-zinc-800 border border-zinc-700 rounded-lg p-6\"><h3 className=\"font-bold text-lg mb-2 text-white\">Como protegen los muebles de valor en Recoleta?","acceptedAnswer":{"@type":"Answer","text":"Usamos mantas acolchadas profesionales, film stretch, cantoneras y cajas especiales para cada tipo de objeto."}},
    {"@type":"Question","name":"Son discretos con las mudanzas en edificios de Recoleta?","acceptedAnswer":{"@type":"Answer","text":"Si, nuestro personal trabaja de forma profesional y silenciosa, respetando a los demás vecinos."}},
    {"@type":"Question","name":"Pueden mover piaños o antiguedades en Recoleta?","acceptedAnswer":{"@type":"Answer","text":"Si, tenemos experiencia en el traslado de piaños, obras de arte y antiguedades con tecnicas y equipamiento especifico."}},
    {"@type":"Question","name":"Trabajan con administraciónes de edificios en Recoleta?","acceptedAnswer":{"@type":"Answer","text":"Si, coordinamos directamente con las administraciónes y porteros de los edificios de Recoleta."}}
  ]
};
      ...
      <main className="pt-20">
        <section className="bg-black text-white py-16 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-4">Mudanzas en Recoleta</h1>
            <p className="text-gray-300 text-lg mb-8">Mudanzas en Recoleta y Barrio Norte. Especialistas en edificios de lujo y manejo de mobiliario de alto valor con total discrecion y cuidado.</p>
        ...
        <section className="bg-black py-16 px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold mb-4 text-center text-white">Empresa de mudanzas en Recoleta</h2>
            <p className="text-gray-300 text-lg text-center">Recoleta exige un nivel de servicio diferente. Sus edificios de categoria, departamentos con pisos de madera y muebles de epoca requieren un equipo que no solo sepa mover objetos sino cuidarlos como si fueran propios. En La Mudanza usamos mantas acolchadas, film stretch y materiales especializados para proteger cada pieza.</p>
          </div>
        </section>

        <section className="bg-zinc-900 py-16 px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold mb-8 text-center text-white">Nuestros servicios en Recoleta</h2>
        ...
        <section className="bg-zinc-900 py-16 px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold mb-8 text-center text-white">Preguntas frecuentes sobre mudanzas en Recoleta</h2>
            <div className="space-y-4">
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6"><h3 className="font-bold text-lg mb-2 text-white">Como protegen los muebles de valor en Recoleta?</h3><p className="text-gray-400">Usamos mantas acolchadas profesionales, film stretch, cantoneras y cajas especiales para cada tipo de objeto.</p></div>
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6"><h3 className="font-bold text-lg mb-2 text-white">Son discretos con las mudanzas en edificios de Recoleta?</h3><p className="text-gray-400">Si, nuestro personal trabaja de forma profesional y silenciosa, respetando a los demás vecinos.</p></div>
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6"><h3 className="font-bold text-lg mb-2 text-white">Pueden mover piaños o antiguedades en Recoleta?</h3><p className="text-gray-400">Si, tenemos experiencia en el traslado de piaños, obras de arte y antiguedades con tecnicas y equipamiento especifico.</p></div>
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6"><h3 className="font-bold text-lg mb-2 text-white">Trabajan con administraciónes de edificios en Recoleta?</h3><p className="text-gray-400">Si, coordinamos directamente con las administraciónes y porteros de los edificios de Recoleta.</p></div>
            </div>
          </div>
        </section>
        ...
        <section className="bg-orange-500 py-16 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-white mb-8 opacity-90">Mudanzas en Recoleta con la empresa más confiable de CABA.</p>
