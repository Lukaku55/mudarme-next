...
const localBusinessSchema = {
  ...
  "name": "La Mudanza - Mudanzas en Tigre",
  "url": "https://www.mudarme.com.ar/mudanzas-tigre",
  ...
  "areaServed": { "@type": "Place", "name": "Tigre, Gran Buenos Aires" },
  "aggregateRating": {
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 2, "name": "Mudanzas en Tigre", "item": "https://www.mudarme.com.ar/mudanzas-tigre" },
  ],
};
...
const faqSchema = {
  ...
  "mainEntity": [
    {"@type":"Question","name":"{s}</h3>
                  <p className=\"text-gray-400\">Realizamos {s.toLowerCase()} en Tigre con vehiculos equipados y personal capacitado.</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className=\"bg-black py-16 px-4\">
          <div className=\"max-w-4xl mx-auto text-center\">
            <h2 className=\"text-3xl font-bold mb-4 text-white\">Por que elegirnos en Tigre</h2>
            <div className=\"grid grid-cols-1 md:grid-cols-3 gap-6 mt-8\">
              <div className=\"p-6 border border-zinc-700 rounded-lg bg-zinc-800\">
                ...
                <p className=\"text-gray-400 text-sm mt-1\">Empresa familiar con trayectoria en Tigre</p>
              </div>
              <div className=\"p-6 border border-zinc-700 rounded-lg bg-zinc-800\">
              ...
              <div className=\"p-6 border border-zinc-700 rounded-lg bg-zinc-800\">
                ...
                <p className=\"text-gray-400 text-sm mt-1\">Miles de mudanzas realizadas en Tigre</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className=\"bg-zinc-900 py-16 px-4\">
          <div className=\"max-w-4xl mx-auto\">
            <h2 className=\"text-3xl font-bold mb-8 text-center text-white\">Preguntas frecuentes sobre mudanzas en Tigre</h2>
            <div className=\"space-y-4\">
              <div className=\"bg-zinc-800 border border-zinc-700 rounded-lg p-6\"><h3 className=\"font-bold text-lg mb-2 text-white\">Pueden entrar a Nordelta y otros countries de Tigre?","acceptedAnswer":{"@type":"Answer","text":"Si, tenemos experiencia entrando a Nordelta y todos los countries del partido de Tigre."}},
    {"@type":"Question","name":"Cuanto cuesta una mudanza desde CABA a Tigre?","acceptedAnswer":{"@type":"Answer","text":"En La Mudanza hacemos presupuestos cerrados y sin cargo. Contactaños por WhatsApp para cotizar."}},
    {"@type":"Question","name":"Hacen mudanzas a las islas de Tigre?","acceptedAnswer":{"@type":"Answer","text":"Si, coordinamos el traslado hasta el embarcadero y el transporte en lancha hasta el destino final."}},
    {"@type":"Question","name":"Con cuanta anticipación hay que reservar para Tigre?","acceptedAnswer":{"@type":"Answer","text":"Para mudanzas a countries recomendamos reservar con al menos 10 dias de anticipación para gestionar los permisos."}}
  ]
};
      ...
      <main className="pt-20">
        <section className="bg-black text-white py-16 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-4">Mudanzas en Tigre</h1>
            <p className="text-gray-300 text-lg mb-8">Mudanzas en Tigre, Nordelta y countries del norte del GBA. Experiencia en barrios privados y zonas de isla.</p>
        ...
        <section className="bg-black py-16 px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold mb-4 text-center text-white">Empresa de mudanzas en Tigre</h2>
            <p className="text-gray-300 text-lg text-center">Tigre es uno de los destinos más elegidos por familias que buscan calidad de vida fuera de la ciudad. Sus countries, barrios cerrados y la zona de islas requieren experiencia especifica en logistica de acceso. En La Mudanza tenemos protocolo para entrar a todos los barrios privados del partido.</p>
          </div>
        </section>

        <section className="bg-zinc-900 py-16 px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold mb-8 text-center text-white">Nuestros servicios en Tigre</h2>
        ...
        <section className="bg-zinc-900 py-16 px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold mb-8 text-center text-white">Preguntas frecuentes sobre mudanzas en Tigre</h2>
            <div className="space-y-4">
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6"><h3 className="font-bold text-lg mb-2 text-white">Pueden entrar a Nordelta y otros countries de Tigre?</h3><p className="text-gray-400">Si, tenemos experiencia entrando a Nordelta y todos los countries del partido de Tigre.</p></div>
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6"><h3 className="font-bold text-lg mb-2 text-white">Cuanto cuesta una mudanza desde CABA a Tigre?</h3><p className="text-gray-400">En La Mudanza hacemos presupuestos cerrados y sin cargo. Contactaños por WhatsApp para cotizar.</p></div>
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6"><h3 className="font-bold text-lg mb-2 text-white">Hacen mudanzas a las islas de Tigre?</h3><p className="text-gray-400">Si, coordinamos el traslado hasta el embarcadero y el transporte en lancha hasta el destino final.</p></div>
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6"><h3 className="font-bold text-lg mb-2 text-white">Con cuanta anticipación hay que reservar para Tigre?</h3><p className="text-gray-400">Para mudanzas a countries recomendamos reservar con al menos 10 dias de anticipación para gestionar los permisos.</p></div>
            </div>
          </div>
        </section>
        ...
        <section className="bg-orange-500 py-16 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-white mb-8 opacity-90">Mudanzas en Tigre con la empresa más confiable de CABA.</p>
