...
const localBusinessSchema = {
  ...
  "name": "La Mudanza - Mudanzas en Villa Urquiza",
  "url": "https://www.mudarme.com.ar/mudanzas-villa-urquiza",
  ...
  "areaServed": { "@type": "Place", "name": "Villa Urquiza, Buenos Aires" },
  "aggregateRating": {
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 2, "name": "Mudanzas en Villa Urquiza", "item": "https://www.mudarme.com.ar/mudanzas-villa-urquiza" },
  ],
};
      ...
      <main className="pt-20">
        <section className="bg-black text-white py-16 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-4">Mudanzas en Villa Urquiza</h1>
            <p className="text-gray-300 text-lg mb-8">Mudanzas en Villa Urquiza, Saavedra y Villa del Parque. Barrio residencial del norte de CABA con gran demanda de mudanzas familiares.</p>
        ...
        <section className="bg-black py-16 px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold mb-4 text-center text-white">Empresa de mudanzas en Villa Urquiza</h2>
            <p className="text-gray-300 text-lg text-center">Villa Urquiza es un barrio de casas con jardín y edificios bajos donde las mudanzas suelen ser más tranquilas. En La Mudanza hemos realizado cientos de mudanzas en Villa Urquiza y sus alrededores, conocemos el barrio y sabemos como organizarnos para que todo salga perfecto.</p>
          </div>
        </section>

        <section className="bg-zinc-900 py-16 px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold mb-8 text-center text-white">Nuestros servicios en Villa Urquiza</h2>
        ...
        <section className="bg-zinc-900 py-16 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-4">
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6"><h3 className="font-bold text-lg mb-2 text-white">Trabajan en casas con jardín en Villa Urquiza?</h3><p className="text-gray-400">Si, tenemos experiencia en mudanzas de casas con jardín en Villa Urquiza.</p></div>
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6"><h3 className="font-bold text-lg mb-2 text-white">Pueden mudarnos desde Villa Urquiza al GBA?</h3><p className="text-gray-400">Si, cubrimos traslados desde Villa Urquiza a todo el Gran Buenos Aires.</p></div>
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6"><h3 className="font-bold text-lg mb-2 text-white">Cuanto demora una mudanza en Villa Urquiza?</h3><p className="text-gray-400">Depende del volumen y el tipo de inmueble. Te damos un estimado cuando hacemos el presupuesto sin cargo.</p></div>
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6"><h3 className="font-bold text-lg mb-2 text-white">Hacen mudanzas de departamentos en Villa Urquiza?</h3><p className="text-gray-400">Si, coordinamos con los consorcios y respetamos los horarios permitidos.</p></div>
            </div>
          </div>
        </section>
        ...
        <section className="bg-orange-500 py-16 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-white mb-8 opacity-90">Mudanzas en Villa Urquiza con la empresa más confiable de CABA.</p>
