        ...
        <section className=\"bg-zinc-900 py-16 px-4\">
          <div className=\"max-w-4xl mx-auto\">
            ...
            <div className=\"space-y-4\">
              <div className=\"bg-zinc-800 border border-zinc-700 rounded-lg p-6\"><h3 className=\"font-bold text-lg mb-2 text-white\">Cuanto cuesta mudarse en Nunez?","acceptedAnswer":{"@type":"Answer","text":"En La Mudanza hacemos presupuestos cerrados y sin cargo. Contactaños por WhatsApp para cotizar."}},
    {"@type":"Question","name":"Cubren Saavedra y Coghlan además de Nunez?","acceptedAnswer":{"@type":"Answer","text":"Si, cubrimos toda la zona norte de CABA incluyendo Nunez, Saavedra y Coghlan."}},
    {"@type":"Question","name":"Pueden mover objetos grandes en casas de Nunez?","acceptedAnswer":{"@type":"Answer","text":"Si, tenemos experiencia con muebles grandes, piaños y objetos voluminosos."}},
    {"@type":"Question","name":"Hacen mudanzas desde Nunez al GBA Norte?","acceptedAnswer":{"@type":"Answer","text":"Si, hacemos traslados desde Nunez a San Isidro, Vicente Lopez, Tigre y todo el GBA Norte."}}
  ]
};
