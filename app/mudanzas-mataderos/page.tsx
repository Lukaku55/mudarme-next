...
const localBusinessSchema = {
  ...
  "name": "La Mudanza - Mudanzas en Mataderos",
  "url": "https://www.mudarme.com.ar/mudanzas-mataderos",
  ...
  "areaServed": { "@type": "Place", "name": "Mataderos, Buenos Aires" },
  "aggregateRating": {
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 2, "name": "Mudanzas en Mataderos", "item": "https://www.mudarme.com.ar/mudanzas-mataderos" },
  ],
};
...
const faqSchema = {
  ...
  "mainEntity": [
    {"@type":"Question","name":"{s}</h3>
                  <p className=\"text-gray-400\">Realizamos {s.toLowerCase()} en Mataderos con vehiculos equipados y personal capacitado.</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className=\"bg-black py-16 px-4\">
          <div className=\"max-w-4xl mx-auto text-center\">
            <h2 className=\"text-3xl font-bold mb-4 text-white\">Por que elegirnos en Mataderos</h2>
            <div className=\"grid grid-cols-1 md:grid-cols-3 gap-6 mt-8\">
              <div className=\"p-6 border border-zinc-700 rounded-lg bg-zinc-800\">
                ...
                <p className=\"text-gray-400 text-sm mt-1\">Empresa familiar con trayectoria en Mataderos</p>
              </div>
              <div className=\"p-6 border border-zinc-700 rounded-lg bg-zinc-800\">
              ...
              <div className=\"p-6 border border-zinc-700 rounded-lg bg-zinc-800\">
                ...
                <p className=\"text-gray-400 text-sm mt-1\">Miles de mudanzas realizadas en Mataderos</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className=\"bg-zinc-900 py-16 px-4\">
          <div className=\"max-w-4xl mx-auto\">
            <h2 className=\"text-3xl font-bold mb-8 text-center text-white\">Preguntas frecuentes sobre mudanzas en Mataderos</h2>
            <div className=\"space-y-4\">
              <div className=\"bg-zinc-800 border border-zinc-700 rounded-lg p-6\"><h3 className=\"font-bold text-lg mb-2 text-white\">Hacen mudanzas entre Mataderos y el GBA Oeste?","acceptedAnswer":{"@type":"Answer","text":"Si, cubrimos traslados entre Mataderos y todos los partidos del GBA Oeste."}},
    {"@type":"Question","name":"Cuanto cuesta una mudanza en Mataderos?","acceptedAnswer":{"@type":"Answer","text":"En La Mudanza hacemos presupuestos cerrados y sin cargo. Contactaños por WhatsApp para cotizar."}},
    {"@type":"Question","name":"Tienen camiónes grandes para casas en Mataderos?","acceptedAnswer":{"@type":"Answer","text":"Si, contamos con camiónes de gran capacidad para mudanzas de casas completas."}},
    {"@type":"Question","name":"Trabajan en Villa Lugano?","acceptedAnswer":{"@type":"Answer","text":"Si, cubrimos Villa Lugano y toda la zona sur de CABA."}}
  ]
};
      ...
      <main className="pt-20">
        <section className="bg-black text-white py-16 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-4">Mudanzas en Mataderos</h1>
            <p className="text-gray-300 text-lg mb-8">Mudanzas en Mataderos, Liniers y Villa Lugano. Servicio profesional en el sur y oeste de CABA con precios accesibles.</p>
        ...
        <section className="bg-black py-16 px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold mb-4 text-center text-white">Empresa de mudanzas en Mataderos</h2>
            <p className="text-gray-300 text-lg text-center">Mataderos y sus alrededores son barrios de casas de familia con mucho volumen de mudanzas. La proximidad con el GBA Oeste hace que muchas familias se muden entre Mataderos, Liniers y partidos como La Matanza. En La Mudanza conocemos estos barrios y sus accesos.</p>
          </div>
        </section>

        <section className="bg-zinc-900 py-16 px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold mb-8 text-center text-white">Nuestros servicios en Mataderos</h2>
        ...
        <section className="bg-zinc-900 py-16 px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold mb-8 text-center text-white">Preguntas frecuentes sobre mudanzas en Mataderos</h2>
            <div className="space-y-4">
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6"><h3 className="font-bold text-lg mb-2 text-white">Hacen mudanzas entre Mataderos y el GBA Oeste?</h3><p className="text-gray-400">Si, cubrimos traslados entre Mataderos y todos los partidos del GBA Oeste.</p></div>
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6"><h3 className="font-bold text-lg mb-2 text-white">Cuanto cuesta una mudanza en Mataderos?</h3><p className="text-gray-400">En La Mudanza hacemos presupuestos cerrados y sin cargo. Contactaños por WhatsApp para cotizar.</p></div>
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6"><h3 className="font-bold text-lg mb-2 text-white">Tienen camiónes grandes para casas en Mataderos?</h3><p className="text-gray-400">Si, contamos con camiónes de gran capacidad para mudanzas de casas completas.</p></div>
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6"><h3 className="font-bold text-lg mb-2 text-white">Trabajan en Villa Lugano?</h3><p className="text-gray-400">Si, cubrimos Villa Lugano y toda la zona sur de CABA.</p></div>
            </div>
          </div>
        </section>
        ...
        <section className="bg-orange-500 py-16 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-white mb-8 opacity-90">Mudanzas en Mataderos con la empresa más confiable de CABA.</p>
