...
const faqSchema = {
  ...
  "mainEntity": [
    {"@type":"Question","name":"{s}</h3>
                  <p className=\"text-gray-400\">Realizamos {s.toLowerCase()} en Villa Devoto con vehiculos equipados y personal capacitado.</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className=\"bg-black py-16 px-4\">
          <div className=\"max-w-4xl mx-auto text-center\">
            <h2 className=\"text-3xl font-bold mb-4 text-white\">Por que elegirnos en Villa Devoto</h2>
            <div className=\"grid grid-cols-1 md:grid-cols-3 gap-6 mt-8\">
              <div className=\"p-6 border border-zinc-700 rounded-lg bg-zinc-800\">
                ...
                <p className=\"text-gray-400 text-sm mt-1\">Empresa familiar con trayectoria en Villa Devoto</p>
              </div>
              <div className=\"p-6 border border-zinc-700 rounded-lg bg-zinc-800\">
              ...
              <div className=\"p-6 border border-zinc-700 rounded-lg bg-zinc-800\">
                ...
                <p className=\"text-gray-400 text-sm mt-1\">Miles de mudanzas realizadas en Villa Devoto</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className=\"bg-zinc-900 py-16 px-4\">
          <div className=\"max-w-4xl mx-auto\">
            <h2 className=\"text-3xl font-bold mb-8 text-center text-white\">Preguntas frecuentes sobre mudanzas en Villa Devoto</h2>
            <div className=\"space-y-4\">
              <div className=\"bg-zinc-800 border border-zinc-700 rounded-lg p-6\"><h3 className=\"font-bold text-lg mb-2 text-white\">Hacen mudanzas de casas grandes en Villa Devoto?","acceptedAnswer":{"@type":"Answer","text":"Si, somos especialistas en mudanzas de casas de 4 y 5 ambientes en Villa Devoto."}},
    {"@type":"Question","name":"Cuanto cuesta mudarse en Villa Devoto?","acceptedAnswer":{"@type":"Answer","text":"En La Mudanza hacemos presupuestos cerrados y sin cargo. Contactaños por WhatsApp para cotizar."}},
    {"@type":"Question","name":"Cubren Villa del Parque y Monte Castro?","acceptedAnswer":{"@type":"Answer","text":"Si, además de Villa Devoto cubrimos Villa del Parque, Monte Castro y todos los barrios del corredor oeste."}},
    {"@type":"Question","name":"Tienen servicio de embalaje en Villa Devoto?","acceptedAnswer":{"@type":"Answer","text":"Si, ofrecemos servicio completo de embalaje con materiales profesionales."}}
  ]
};
      ...
      <main className="pt-20">
        <section className="bg-black text-white py-16 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-4">Mudanzas en Villa Devoto</h1>
            <p className="text-gray-300 text-lg mb-8">Mudanzas en Villa Devoto, Villa del Parque y Monte Castro. Barrios familiares del oeste de CABA con casas amplias.</p>
        ...
        <section className="bg-black py-16 px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold mb-4 text-center text-white">Empresa de mudanzas en Villa Devoto</h2>
            <p className="text-gray-300 text-lg text-center">Villa Devoto es uno de los barrios más tranquilos y familiares de CABA, con casas de dos plantas, jardínes y calles arboladas. En La Mudanza nos especializamos en mudanzas de casas y conocemos bien las particularidades de Villa Devoto y sus alrededores.</p>
          </div>
        </section>

        <section className="bg-zinc-900 py-16 px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold mb-8 text-center text-white">Nuestros servicios en Villa Devoto</h2>
        ...
        <section className="bg-zinc-900 py-16 px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold mb-8 text-center text-white">Preguntas frecuentes sobre mudanzas en Villa Devoto</h2>
            <div className="space-y-4">
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6"><h3 className="font-bold text-lg mb-2 text-white">Hacen mudanzas de casas grandes en Villa Devoto?</h3><p className="text-gray-400">Si, somos especialistas en mudanzas de casas de 4 y 5 ambientes en Villa Devoto.</p></div>
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6"><h3 className="font-bold text-lg mb-2 text-white">Cuanto cuesta mudarse en Villa Devoto?</h3><p className="text-gray-400">En La Mudanza hacemos presupuestos cerrados y sin cargo. Contactaños por WhatsApp para cotizar.</p></div>
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6"><h3 className="font-bold text-lg mb-2 text-white">Cubren Villa del Parque y Monte Castro?</h3><p className="text-gray-400">Si, además de Villa Devoto cubrimos Villa del Parque, Monte Castro y todos los barrios del corredor oeste.</p></div>
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6"><h3 className="font-bold text-lg mb-2 text-white">Tienen servicio de embalaje en Villa Devoto?</h3><p className="text-gray-400">Si, ofrecemos servicio completo de embalaje con materiales profesionales.</p></div>
            </div>
          </div>
        </section>
        ...
        <section className="bg-orange-500 py-16 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-white mb-8 opacity-90">Mudanzas en Villa Devoto con la empresa más confiable de CABA.</p>
