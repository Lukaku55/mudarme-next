...
const localBusinessSchema = {
  ...
  "name": "La Mudanza - Mudanzas en Quilmes",
  "url": "https://www.mudarme.com.ar/mudanzas-quilmes",
  ...
  "areaServed": { "@type": "Place", "name": "Quilmes, Gran Buenos Aires" },
  "aggregateRating": {
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 2, "name": "Mudanzas en Quilmes", "item": "https://www.mudarme.com.ar/mudanzas-quilmes" },
  ],
};
...
const faqSchema = {
  ...
  "mainEntity": [
    {"@type":"Question","name":"{s}</h3>
                  <p className=\"text-gray-400\">Realizamos {s.toLowerCase()} en Quilmes con vehiculos equipados y personal capacitado.</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className=\"bg-black py-16 px-4\">
          <div className=\"max-w-4xl mx-auto text-center\">
            <h2 className=\"text-3xl font-bold mb-4 text-white\">Por que elegirnos en Quilmes</h2>
            <div className=\"grid grid-cols-1 md:grid-cols-3 gap-6 mt-8\">
              <div className=\"p-6 border border-zinc-700 rounded-lg bg-zinc-800\">
                ...
                <p className=\"text-gray-400 text-sm mt-1\">Empresa familiar con trayectoria en Quilmes</p>
              </div>
              <div className=\"p-6 border border-zinc-700 rounded-lg bg-zinc-800\">
              ...
              <div className=\"p-6 border border-zinc-700 rounded-lg bg-zinc-800\">
                ...
                <p className=\"text-gray-400 text-sm mt-1\">Miles de mudanzas realizadas en Quilmes</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className=\"bg-zinc-900 py-16 px-4\">
          <div className=\"max-w-4xl mx-auto\">
            ...
            <div className=\"space-y-4\">
              <div className=\"bg-zinc-800 border border-zinc-700 rounded-lg p-6\"><h3 className=\"font-bold text-lg mb-2 text-white\">Cuanto cuesta mudarse desde CABA a Quilmes?","acceptedAnswer":{"@type":"Answer","text":"En La Mudanza hacemos presupuestos cerrados y sin cargo. Contactaños por WhatsApp para cotizar."}},
    {"@type":"Question","name":"Cubren Bernal y Berazategui?","acceptedAnswer":{"@type":"Answer","text":"Si, cubrimos Quilmes, Bernal, Berazategui y partidos vecinos del sur del GBA."}},
    {"@type":"Question","name":"Hacen mudanzas de locales comerciales en Quilmes?","acceptedAnswer":{"@type":"Answer","text":"Si, además de mudanzas residenciales hacemos traslados de locales comerciales y oficinas en Quilmes."}},
    {"@type":"Question","name":"Cuanto tardan en llegar a Quilmes desde CABA?","acceptedAnswer":{"@type":"Answer","text":"Dependiendo del trafico llegamos a Quilmes en entre 40 minutos y una hora."}}
  ]
};
  ...
  return (
    <>
      ...
      <main className="pt-20">
        ...
        <section className="bg-black py-16 px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold mb-4 text-center text-white">Empresa de mudanzas en Quilmes</h2>
            <p className="text-gray-300 text-lg text-center">Quilmes es una ciudad en constante crecimiento con una gran demanda de mudanzas. El corredor sur del GBA conecta Quilmes con CABA y con otros partidos como Berazategui y Florencio Varela. En La Mudanza cubrimos todo el partido con la misma calidad que ofrecemos en Capital.</p>
          </div>
        </section>

        <section className="bg-zinc-900 py-16 px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold mb-8 text-center text-white">Nuestros servicios en Quilmes</h2>
